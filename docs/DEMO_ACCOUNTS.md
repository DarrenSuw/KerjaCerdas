...
| `siti.nurhaliza@example.com` | Siti Nurhaliza | Akuntan junior 2 tahun |
| `budi.santoso@example.com` | Budi Santoso | Teknisi otomotif 5 tahun |
| `putri.maharani@example.com` | Putri Maharani | Apoteker fresh-grad UGM |
| `reza.pahlawan@example.com` | Reza Pahlawan | Senior backend engineer (Go/Java) 6 tahun |
| `maya.sari@example.com` | Maya Sari | Admin retail SMA, entry-level |
| `joko.widodo.p@example.com` | Joko Widodo Pratama | Supply chain analyst 3 tahun |
| `dewi.kartika@example.com` | Dewi Kartika | Content writer & digital marketer 4 tahun |
| `hendra.setiawan@example.com` | Hendra Setiawan | Hotel ops 2 tahun Bali |
| `linda.halim@example.com` | Linda Halim | Banker BCA 7 tahun |
| `agus.salim@example.com` | Agus Salim | Cook 3 tahun Bandung |
| `rina.wijaya@example.com` | Rina Wijaya | UI designer freelance 3 tahun |
| `bayu.aditya@example.com` | Bayu Aditya | Project engineer konstruksi 4 tahun |
| `nadia.putri@example.com` | Nadia Putri | HR generalist 2 tahun |
| `faisal.rahman@example.com` | Faisal Rahman | Maintenance technician 5 tahun |
| `citra.lestari@example.com` | Citra Lestari | Legal trainee 1 tahun |
| `iwan.setyo@example.com` | Iwan Setyo | Sales 8 tahun (retail & property) |
| `yuni.astuti@example.com` | Yuni Astuti | Perawat RS 6 tahun |
| `aldi.pramudya@example.com` | Aldi Pramudya | QA tester 1 tahun |
| `sri.wahyuni@example.com` | Sri Wahyuni | Field officer pertanian 5 tahun |
| `rudi.hartono@example.com` | Rudi Hartono | Kasir & pelayan warung makan 2 tahun (Malang) |
| `wahyu.nugroho@example.com` | Wahyu Nugroho | Mekanik motor 3 tahun (Bogor) |
| `ratna.dewi@example.com` | Ratna Dewi | Terapis spa & kecantikan 2 tahun (Denpasar) |
| `slamet.riyadi@example.com` | Slamet Riyadi | Penjahit konveksi 4 tahun (Surakarta) |
| `yeni.marlina@example.com` | Yeni Marlina | Staff operasional laundry 1 tahun (Medan) |
