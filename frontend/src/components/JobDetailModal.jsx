                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 320px', gap: 0, overflowY: 'auto', flex: 1 }}>
                        ...
                        <div style={{ padding: '26px 28px', borderRight: '1.5px solid #E2E8F0' }}>
                            {hasScore ? (
                                ...
                                <div style={{ padding: '14px 16px', background: '#F8FAFC', border: '1px solid #E2E8F0', borderRadius: 9, marginBottom: 26, font: '600 12.5px/1.5 "Plus Jakarta Sans", sans-serif', color: '#64748B' }}>
                                    Skor kecocokan belum dihitung untuk lowongan ini. Jalankan Pencocokan AI dari dashboard untuk melihat rincian skor.
                                </div>
                            )}
                    ...
                    <>
                        <div style={{ flex: 1, overflowY: 'auto', padding: '14px 18px 18px' }}>
                            ...
                            {hasScore ? (
                                ...
                                <div style={{ padding: '12px 14px', background: '#F8FAFC', border: '1px solid #E2E8F0', borderRadius: 9, marginBottom: 14, fontSize: 12, color: '#64748B', lineHeight: 1.5 }}>
                                    Skor kecocokan belum dihitung untuk lowongan ini. Jalankan Pencocokan AI dari dashboard untuk melihat rincian skor.
                                </div>
                            )}
