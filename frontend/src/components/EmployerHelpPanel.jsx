...
const TIPS = [
    ...
    },
    {
        ...
        body: 'Di Lowongan Saya, klik "Link & QR". Tempel link di bio Instagram / grup WhatsApp atau cetak posternya. Pelamar masuk langsung ke tab Pelamar yang sudah diperingkat.',
    },
    {
        id: 'pipeline',
        icon: '📋',
        title: 'Status Lamaran & Konfirmasi Skill',
        body: 'Pindahkan status (Ditinjau → Wawancara → Ditawari → Diterima). Setelah wawancara, buka "Wawancara & konfirmasi skill" dan tandai skill yang terbukti — itu bukti terkuat bagi kandidat.',
    },
    {
        id: 'automod',
        icon: '🛡️',
        title: 'Kenapa Lowongan Ditahan?',
        body: 'AutoMod menolak lowongan yang meminta biaya dari pelamar dan menahan syarat usia/penampilan/jenis kelamin tanpa alasan. Kamu mendapat kalimat yang bermasalah dan cara memperbaikinya, atau bisa ajukan banding.',
    },
    {
        id: 'verify',
        icon: '🏢',
        title: 'Badge Kepercayaan',
        body: 'Verifikasi email; gunakan email dengan domain website perusahaan untuk badge "Email perusahaan", atau ajukan "Ditinjau admin" dengan tautan Google Maps / Instagram bisnis. Tanpa NPWP.',
    },
]
